            ...
            <figure className={style.presentacion}>
              ...
              <figcaption className={style.descripcion}>
                <p className={style.descripcionTitulo}>
                  ...
                  Doloremque sed aliquid unde at voluptatum optio soluta,
                  tempore molestias molestiae, suscipit eum repudiandae, a
                  nobis! Suscipit facere necessitatibus exercitationem soluta
                  eveniet.
                </p>
              </figcaption>
            </figure>
          ...
          <section className={style.ambientes}>
            <figure className={style.contenedorFotos}>
              ...
              <figcaption className={style.descripcionFotos}>
                ...
                vel iste obcaecati ullam, ex eligendi. Vitae, ut! Accusamus
                optio perferendis doloribus numquam maiores ipsa error vitae
                natus cupiditate! Consectetur, ipsum!
              </figcaption>
            </figure>
          </section>
          <section className={style.ambientes}>
