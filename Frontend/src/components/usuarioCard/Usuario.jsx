        ...
        <main className={style.contenedorUsuario}>
            <section className={style.contenedorDatosUsuario}>
                ...
                <section className={style.informacionCuenta}>
                    ...
                    <hr />
                    <p className={style.informacion}><FaEnvelope className={style.iconoInformacion}/>{correoElectrico}</p>
                    <p className={style.informacion}><FaCalendar className={style.iconoInformacion}/>Registrado el:{fechaDeRegistro}</p>
                    <p className={style.informacion}><FaUserShield className={style.iconoInformacion}/>Rol:{rol}</p>
                </section>
